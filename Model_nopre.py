...
for ite in range(20):
    ...
    best_accu = 80
    f_path=open(f'noprevgg_result_{ite}.txt','a',encoding='utf8')
    ...
    for epoch in range(pre_epoch, EPOCH):
        ...
        if accu>80:
            # best_accu = accu
            torch.save(net,'noprevgg_%d_1208_%.3f.pth'%(ite,accu))
    ...
    best_accu = 80
    f_path=open(f'nopredense_result_{ite}.txt','a',encoding='utf8')
    ...
    for epoch in range(pre_epoch, EPOCH):
        ...
        if accu>80:
            # best_accu = accu
            torch.save(net,'nopredense_%d_1208_%.3f.pth'%(ite,accu))
        Test_accu.append(100.*correct.item()/total)
    # print('Train_loss:',list(Train_loss))
    # print('Train_accu:',list(Train_accu))
    # print('Test_accu:',list(Test_accu))
    ...
    best_accu = 80
    f_path=open(f'nopreres_result_{ite}.txt','a',encoding='utf8')
    ...
    for epoch in range(pre_epoch, EPOCH):
        ...
        if accu>80:
            # best_accu = accu
            torch.save(net,'nopreres_%d_1208_%.3f.pth'%(ite,accu))
        Test_accu.append(100.*correct.item()/total)
    # print('Train_loss:',list(Train_loss))
    # print('Train_accu:',list(Train_accu))
    # print('Test_accu:',list(Test_accu))
